...
class TransitionMakerPresent : NSObject , UIViewControllerAnimatedTransitioning {
    ...
    func animateTransitionObject(transitionObject : TransitionObject, fromViewController : UIViewController, toViewController : UIViewController, containerView : UIView) {
        ...
        case let imageScaleTransition as ImageScaleTransitionObject:
            ImageScaleTransitionPresent.animateTransitionObject(transitionObject: imageScaleTransition, fromViewController: fromViewController, toViewController: toViewController, containerView: containerView, animationOptions: animationOptions, fadeOutAnimationDelay: fadeOutAnimationDelay)
        case let crossFadeUpwards as CrossfadeUpwardTransitionObject:
            CrossfadeUpwardTransitionPresent.animateTransitionObject(transitionObject: crossFadeUpwards, fromViewController: fromViewController, toViewController: toViewController, containerView: containerView, animationOptions: animationOptions, fadeOutAnimationDelay: fadeOutAnimationDelay)
        default: break
